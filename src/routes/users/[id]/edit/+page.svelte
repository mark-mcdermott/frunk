			...
			{#if isAdminEditing}
				...
				<form method="post" action="?/update" use:enhance class="space-y-4">
					...
					<div class="flex gap-3">
						...
						<button type="submit" formaction="?/delete" formmethod="POST" class="flex-1 btn py-2.5 rounded-lg font-semibold border border-red-500 bg-transparent text-black dark:text-white hover:bg-red-50 dark:hover:bg-red-500/10" onclick={(e) => {
